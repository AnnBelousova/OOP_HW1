...
public class Main {
    public static void main(String[] args) {
        ...
        Car lada = new Car("Lada", "Granta", 1.7, "yellow", 2015, "Russia",5,null, "x456sa777", "automate", "sedan");
        Car audi= new Car("Audi", "A8 50 l TDl quattro", 3.0, "black", 2020, "Germany",5, true, null, null, "hatchback");
        Car bmw = new Car("BMW", "Z8", 3.0, "black", 2021, "Germany",5, false, "456sa777", null, null);
        Car kia = new Car("Kia", "Sportage 4", 2.4, "red", 2018, "South Korea",6, null, "d456sa777", "mechanical", "suv");
        Car hyundai = new Car("Hyundai", "Avante", 1.6, "orange", 2016, "South Korea",6, true, "r456sa", null, null);
        Car carWithoutInfo = new Car("", null, 0, "", 0, "",0, null, null, "automate", "sedan");

        Car.Key remoteWithoutKey = new Car.Key(true, false);
        bmw.setKey(remoteWithoutKey);
